define([], function() {
	...
	var VirtualJoystick	= function(opts)
	{
		...
		this._strokeStyleBaseExt        = opts.strokeStyle	|| 'red';
		this._strokeStyleBaseInt        = opts.strokeStyle	|| '#F59393';
		this._strokeStyleJoy            = opts.strokeStyle	|| 'yellow';
	...
	*/
	...
	VirtualJoystick.prototype._buildJoystickBase	= function()
	{
		...
		ctx.beginPath(); 
		ctx.strokeStyle = this._strokeStyleBaseInt; 
		ctx.lineWidth	= 6; 
		ctx.arc( canvas.width/2, canvas.width/2, 40, 0, Math.PI*2, true); 
		ctx.stroke();	

		ctx.beginPath(); 
		ctx.strokeStyle	= this._strokeStyleBaseExt; 
		ctx.lineWidth	= 2; 
	...
	VirtualJoystick.prototype._buildJoystickStick	= function()
	{
		...
		var ctx		= canvas.getContext('2d');
		ctx.beginPath(); 
		ctx.strokeStyle	= this._strokeStyleJoy; 
		ctx.lineWidth	= 6; 
		ctx.arc( canvas.width/2, canvas.width/2, 40, 0, Math.PI*2, true); 
		ctx.stroke();
		return canvas;
